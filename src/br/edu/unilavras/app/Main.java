package br.edu.unilavras.app;

import br.edu.unilavras.model.Cliente;
import br.edu.unilavras.model.Entregador;
import br.edu.unilavras.model.Restaurante;
import br.edu.unilavras.model.Usuario;
import br.edu.unilavras.services.EntregaBicicleta;
import br.edu.unilavras.services.EntregaMoto;
import br.edu.unilavras.services.Entregavel;
import br.edu.unilavras.services.SistemaDelivery;
...
public class Main {
    public static void main(String[] args) {
        ...
        // variaveis de interface para mostrar polimorfismo
        Entregavel moto = new EntregaMoto();
        Entregavel bike = new EntregaBicicleta();

        // pedidos
        sistema.adicionarPedido(c2, r2, 50, moto);
        sistema.adicionarPedido(c1, r1, 90, bike);
